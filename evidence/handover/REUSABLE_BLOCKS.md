...
- **Usage sites**: `pages/Login/index.tsx`; `layouts/BasicLayout.tsx`; `pages/WorkOrder/Internal/Detail.tsx`; `components/Access.tsx`.
...
- **Path(s)**: `frontend/dfbs-ui/src/components/Access.tsx`
